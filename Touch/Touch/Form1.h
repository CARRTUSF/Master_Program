...
//			 varscreenopn = 1;
/*			 if (VAR_DXnadis!=0){
				 if(VAR_DX[0]==1){checkBox1->Checked=true;}
				 if(VAR_DX[1]==1){checkBox2->Checked=true;}
				 if(VAR_DX[2]==1){checkBox3->Checked=true;}
				 if(VAR_DX[3]==1){checkBox4->Checked=true;}
				 if(VAR_DX[4]==1){checkBox5->Checked=true;}
				 if(VAR_DX[5]==1){checkBox6->Checked=true;}
				 if(VAR_DX[6]==1){checkBox7->Checked=true;}
				 if(VAR_DX[7]==1){checkBox8->Checked=true;}
				 if(VAR_DX[8]==1){checkBox9->Checked=true;}
				 if(VAR_DX[9]==1){checkBox10->Checked=true;}
				 if(VAR_DX[10]==1){checkBox11->Checked=true;}
				 if(VAR_DX[11]==1){checkBox12->Checked=true;}
				 if(VAR_DX[12]==1){checkBox13->Checked=true;}
				 if(VAR_DX[13]==1){checkBox14->Checked=true;}
