...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &Exit::button1_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &Exit::button2_Click);
			// 
			// Exit
			// 
			...
			this->Name = L"Exit";
			this->Text = L"Exit";
			this->Load += gcnew System::EventHandler(this, &Exit::Exit_Load);
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void Exit_Load(System::Object^  sender, System::EventArgs^  e) {
				 Exit::CenterToScreen(); 
				 varscreenopn = 1;
			 }
