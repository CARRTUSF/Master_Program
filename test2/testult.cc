	...
	if (ini==0){   // When no "park" to "ready" motion required.
		...
		for (i=0;i<=n+1;i++){
			...
			if (cart==2){
				...
				for (j=0;j<6;j++){
					for (k=0;k<9;k++){
						fprintf(fid2," %4.f ",  Jo(j,k));
					}
					fprintf(fid2," \n");
				}
				fprintf(fid2," \n\n\n");
				fprintf(fid2," %g",  detJo);
				fprintf(fid2," i is %i ",  i);
				fprintf(fid2," \n");
				fprintf(fid2," \n\n\n");
			}
			...
			for (j=0;j<9;j++){
				fprintf(fid2," %4.f ",  qo(j,0));
			}
			fprintf(fid2," \n");
			fprintf(fid2," \n\n\n");
			for (j=0;j<4;j++){
				for (k=0;k<4;k++){
					fprintf(fid2," %4.f ",  To(j,k));
				}
				fprintf(fid2," \n");
			}
			fprintf(fid2," \n\n\n");
			...
			for (j=0;j<4;j++){
				for (k=0;k<4;k++){
					fprintf(fid2," %4.f ",  Towc(j,k));
				}
				fprintf(fid2," \n");
			}
			fprintf(fid2," \n\n");
			fprintf(fid2," tt i %4.f ",  tt);
			fprintf(fid2," \n");
			fprintf(fid2," i is %i ",  i);
			fprintf(fid2," \n");
			fprintf(fid2," \n\n\n");
